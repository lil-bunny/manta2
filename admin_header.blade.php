 function: header 
docstring: This function generates the header for the admin panel page. It includes elements such as the user's name, notification count, and profile dropdown. 
purpose: The purpose of this functionality is to provide a user-friendly and visually appealing navigation bar for the admin panel page. It also allows the user to access important information and navigate to different sections of the panel easily. <!-- BEGIN: Header-->
