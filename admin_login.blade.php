...
docstring: This function renders the login page for the admin panel.
purpose: To provide a user-friendly interface for the admin to login and access the admin panel for managing the software. This helps in enhancing the security and accessibility of the software.<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
