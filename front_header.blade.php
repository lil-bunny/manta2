 function: render_header
  docstring: This function renders the header component of the website. It includes the logo, login and sign up buttons, and user profile dropdown for authenticated users.
  purpose: This functionality is used to create a consistent and visually appealing header for the website. It also provides a convenient way for users to access their profile and log in or sign up for an account. <!-- HEADER -->
