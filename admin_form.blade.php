 function: admin_layout
  docstring: This function generates the layout for the admin dashboard, including the topbar, sidebar, content, and footer.
  purpose: This functionality allows for the consistent and organized display of the admin dashboard, providing easy navigation and access to important information and features for the user. <!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
