...
Function: get_users
Docstring: Fetches all the users with their roles and displays on the admin user listing page.
Purpose: This functionality allows the admin to view and manage all the registered users on the website. It provides a comprehensive list of users along with their roles, making it easier for the admin to track and manage user accounts. This helps in efficient user management and maintaining the security of the website.// fetching roles
